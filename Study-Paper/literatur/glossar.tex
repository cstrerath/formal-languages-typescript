...
\newglossaryentry{conskodierung}{
    name={Cons-Kodierung},
    description={Umwandlung einer flachen Folge von Elementen in eine rekursiv verschachtelte Listenstruktur aus Kopf und Rest (Cons-Zellen)}
}
